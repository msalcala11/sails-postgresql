...
module.exports = (function() {
  ...
  function getPool(connectionName, connectionConfig) {
    if(!pools[connectionName]) {
      pools[connectionName] = new Pool(connectionConfig)
    }
  ...
  function spawnConnection(connectionName, logic, cb) {
    ...
    var pool = getPool(connectionName, connectionConfig)
